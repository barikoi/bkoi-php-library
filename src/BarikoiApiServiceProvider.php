...
class BarikoiApiServiceProvider extends ServiceProvider
{
    ...
    {
        $configPath = __DIR__ . '/../config/barikoiapi.php';

        $this->publishes([$configPath => config_path('barikoiapi.php')], 'config');
    ...
    public function register()
    {
        ...
        $this->app->alias('barikoiapi', 'Barikoi\BkoiPhpLibrary\BarikoiApiClient');
    }
